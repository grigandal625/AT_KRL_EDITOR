...
INSTALLED_APPS = [
    ...
    "drf_spectacular",
    "corsheaders",
    "at_krl_editor.apps.knowledge_base",
]
...
ROOT_URLCONF = "at_krl_editor.base_server.urls"
...
WSGI_APPLICATION = "at_krl_editor.base_server.wsgi.application"
...
CELERY_IMPORTS = ("at_krl_editor.apps.knowledge_base.tasks",)
